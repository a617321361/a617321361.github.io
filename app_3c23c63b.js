...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + chunkId + ".app_" + {"0":"aeb62ce8"}[chunkId] + ".js";
...
function createBrowserHistory(props) {
  ...
  !canUseDOM ?  false ? invariant(false, 'Browser history needs a DOM') : tiny_invariant_esm(false) : void 0;
...
function createHashHistory(props) {
  ...
  !canUseDOM ?  false ? invariant(false, 'Hash history needs a DOM') : tiny_invariant_esm(false) : void 0;
  var globalHistory = window.history;
...
var _freeGlobal = __webpack_require__(367);
...
var es = __webpack_require__(368);
...
var esm_history = __webpack_require__(35);

// EXTERNAL MODULE: ./node_modules/invariant/browser.js
var invariant_browser = __webpack_require__(36);
...
var BrowserRouter_BrowserRouter = function (_React$Component) {
  ...
  function BrowserRouter() {
    ...
    return _ret = (_temp = (_this = BrowserRouter__possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = Object(esm_history["createBrowserHistory"])(_this.props), _temp), BrowserRouter__possibleConstructorReturn(_this, _ret);
  }
...
var HashRouter_HashRouter = function (_React$Component) {
  ...
  function HashRouter() {
    ...
    return _ret = (_temp = (_this = HashRouter__possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = Object(esm_history["createHashHistory"])(_this.props), _temp), HashRouter__possibleConstructorReturn(_this, _ret);
  }
...
var Link_Link = function (_React$Component) {
  ...
  Link.prototype.render = function render() {
    ...
    var location = typeof to === "string" ? Object(esm_history["createLocation"])(to, null, null, history.location) : to;
...
var MemoryRouter_MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = MemoryRouter__possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = Object(esm_history["createMemoryHistory"])(_this.props), _temp), MemoryRouter__possibleConstructorReturn(_this, _ret);
  }
...
var path_to_regexp = __webpack_require__(142);
...
var Redirect__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Redirect_Redirect = function (_React$Component) {
  ...
  Redirect.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    var prevTo = Object(esm_history["createLocation"])(prevProps.to);
    var nextTo = Object(esm_history["createLocation"])(this.props.to);

    if (Object(esm_history["locationsAreEqual"])(prevTo, nextTo)) {
...
var hoist_non_react_statics_cjs = __webpack_require__(143);
  ...
  var C = function C(props) {
    ...
    return react_default.a.createElement(es_Route, {
      children: function children(routeComponentProps) {
        return react_default.a.createElement(Component, withRouter__extends({}, remainingProps, routeComponentProps, {
...
exports.setIdcar = setIdcar;
exports.setTokenDelay = setTokenDelay;
var SET_TOKEN = exports.SET_TOKEN = 'SET_TOKEN';
var SET_ORDER_INFO = exports.SET_ORDER_INFO = 'SET_ORDER_INFO';
var SET_USERID = exports.SET_USERID = 'SET_USERID';
var SET_PLAN = exports.SET_PLAN = 'SET_PLAN';
var SET_IDCAR = exports.SET_IDCAR = 'SET_IDCAR';
//token
...
function setOrderInfo(orderInfo) {
    return { type: SET_ORDER_INFO, orderInfo: orderInfo };
}
//用户ID
...
//方案选择
function setPlan(selectplan) {
    return { type: SET_PLAN, selectplan: selectplan };
}
//身份证
function setIdcar(idcar) {
    return { type: SET_IDCAR, idcar: idcar };
}

function setTokenDelay(token, devToken) {
    return function (dispatch, getState) {
        // console.log(getState().setToken.token)
        if (token != '') {
...
exports.Trim = Trim;
exports.yzname = yzname;
exports.emailcheck = emailcheck;
exports.YZBMYZ = YZBMYZ;
...
exports.Id_to_sex = Id_to_sex;
exports.Id_to_birthday = Id_to_birthday;
exports.getRequest = getRequest;
exports.timetochange = timetochange;
exports.getrelative = getrelative;
exports.Pdtbbirthday = Pdtbbirthday;
exports.deepClone = deepClone;
exports.jsGetAge = jsGetAge;
exports.tuomin = tuomin;
exports.yztuomin = yztuomin;
exports.showbodyalertbox = showbodyalertbox;
exports.getClientHeight = getClientHeight;
exports.fomatetime = fomatetime;
...
function format(time, format) {
    // console.log(222222222222222222222,time, format)
    ...
    var AsyncComponent = function (_Component) {
        ...
        _createClass(AsyncComponent, [{
            ...
            value: function render() {
                ...
                // console.log(211111111,this)
                if (window.location.href.split('/Explorer/').length == 2 || window.location.href.split('/promition/').length == 2 || window.location.href.split('/agreement/').length == 2 || window.location.href.split('/CarWashActivity/').length == 2) {
                    return C ? _react2.default.createElement(C, this.props) : '';
                } else if (window.location.href.split('/CarWash/').length == 2) {
                    return C ? _react2.default.createElement(C, this.props) : '';
                } else {
                    return C ? _react2.default.createElement(C, this.props) : '';
                }
...
function isPoneAvailable(str) {
    str = Trim(str);
    if (str.length == 11 && str.split('****').length == 2) {
        //如果是脱敏身份证号则不验证
        return true;
    }
...
function isIdCard(cardid) {
    //console.log(889,cardid)
    cardid = Trim(cardid);
    if (cardid.length == 18 && cardid.split('***********').length == 2) {
        //如果是脱敏身份证号则不验证
        return true;
    }
    //身份证正则表达式(15位) 
    if (cardid.length == 15) {
        ...
        if (pattern.exec(cardid) == null) {
            comInfo("15位身份证号码必须为数字！");
            return false;
        } else {
            //将15位转成18位身份证号码
            cardid = C15ToC18(cardid);
        }
    }
    console.log(cardid);
    //身份证正则表达式(18位) 
    ...
    if (birthday != format(year + '/' + month + '/' + day, 'yyyyMMdd')) {
        //校验日期是否合法
        comInfo('身份证号格式错误!');
        return false;
    }
...
function YZBMYZ(val) {
    ...
    function CheckPostCode(val) {
        var MyNumber = val.search(/^[1-9]{1}[0-9]{5}$/);
        if (MyNumber == -1) {
            return false;
        } else {
            return true;
...
//验证字段总路口
function Field_validation(obj1, obj2, callback) {
    //obj1为字段列表；obj2为字段列表值;callback为回调函数
    for (var i = 0; i < obj1.list.length; i++) {
        //遍历state字段
        var Sname = obj1.list[i].key; //获取字段所对应的key
        var pval = obj2[obj1.type][Sname]; //获取insForm里所对应的key值
        if (pval == '' || pval == undefined || pval == null) {
            comInfo(obj1.tit + ' : ' + obj1.list[i].name + '不能为空！');
            return false;
        } else if (obj1.list[i].Yzfield == 'name' && !yzname(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'IDnumber' && !isIdCard(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'phone' && !isPoneAvailable(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'YZBM' && !YZBMYZ(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'email' && !emailcheck(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'LicensePlate' && !isVehicleNumber(pval)) {
            return false;
        } else if (obj1.list[i].Yzfield == 'busID' && !yzcjh(pval)) {
            console.log('yzcjh');
            return false;
        }
    }
...
//信息弹框
function comInfo(str) {
    $('body').append('<div class="cominfo" style="position: absolute;' + 'width: 44%;' + 'bottom: 20%;' + 'background: rgba(0, 0, 0, 0.7);' + ' color: #fff;' + ' text-align: center;' + 'font-size: 12px;' + ' left: 25%;' + ' z-index: 9999;' + ' line-height: 18px;' + 'border-radius: 5px;' + ' padding: 10px 3%;display:none">' + str + '</div>');
    $('.cominfo').fadeIn(500);
    setTimeout(function () {
        $('.cominfo').fadeOut(500, function () {
            $('.cominfo').remove();
        });
    }, 2500);
}

//获取终端设备系统 return string => android || ios || wechat || pcweb
...
//将年月日期格式转换成标准时间 2018-05-01 ==>Thu Mar 19 2015 12:00:00 GMT+0800 (中国标准时间)
function timetochange(date) {
    var mydata = date.replace(/-/g, '/');
    var t = Date.parse(mydata);
    // alert(t)  
    if (!isNaN(t)) {
...
//根据关系给出对应ID
function getrelative(arr, namel) {
    var nn = '';
    arr.map(function (value, key) {
        if (value.name == namel) {
            nn = value.relationshipId;
        }
    });
    return nn;
}

function Pdtbbirthday(str) {
    var newday = str.split('-');
    var date = new Date();
    var year = date.getFullYear(); //年
    var month = date.getMonth() + 1; //月 
    var strDate = date.getDate(); //日
    var ny = year - newday[0];
    console.log(123, ny);
    if (ny < 18) {
        comInfo('投保人年龄必须在18周岁以上');
        return false;
    }
    if (ny == 18 && newday[1] > month) {
        comInfo('投保人年龄必须在18周岁以上');
        return false;
    }if (ny == 18 && newday[1] == month && newday[2] > strDate) {
        comInfo('投保人年龄必须在18周岁以上');
        return false;
    } else {
...
function tuomin(name, type) {
    ...
    if (type == 'phone') {
        console.log(name);
        num += name.substring(0, 3);
        num += '****';
        console.log(name);
        num += name.substring(7, 11);
        return num;
    } else if (type == 'idcar') {
        console.log(name);
        num += name.substring(0, 3);
...
function yztuomin(name, name1) {
    console.log(21231231, name, name1);
    if (!name) {
        return name;
    }
    if (!name1.idcar) {
    ...
    var obj = JSON.parse(JSON.stringify(name1)); //深拷贝

    if (name == tuomin(obj.idcar, 'idcar')) {
        return name1.idcar;
    } else if (name == tuomin(obj.phone, 'phone')) {
        return name1.phone;
    } else {
        return name;
    }
...
//自制弹框
function showbodyalertbox(title, txttype, callback) {
    var txtobj = {
        'rz': ['继续', '去认证'], //认证
        'sb': ['否', '是'], //社保
        'jkgz': ['我知道了'], //健康告知
    ...
    if (txtobj[txttype][1]) {
        $('body').append('<div class="bofyalertbox">' + '<div class="boxl">' + '<p>' + title + '</p>' + '<div class="btmbox">' + '<label  class="bodyno">' + txtobj[txttype][0] + '</label>' + '<label  class="bodyyes">' + txtobj[txttype][1] + '</label>' + '</div>' + '</div>' + '</div>');
    } else {
        $('body').append('<div class="bofyalertbox">' + '<div class="boxl">' + '<p>' + title + '</p>' + '<div class="btmbox">' + '<label  class="bodyno" style="width:100%" >' + txtobj[txttype][0] + '</label>' + '</div>' + '</div>' + '</div>');
    }

    $('.bofyalertbox').fadeIn(100);

    $('.bodyno').on('click', function () {
        console.log('no');
        $('.bofyalertbox').fadeOut(50);
        $('.bofyalertbox').remove();
        callback(false);
    });
    $('.bodyyes').on('click', function () {
        console.log('yes');
        $('.bofyalertbox').fadeOut(50);
        $('.bofyalertbox').remove();
        callback(true);
...
// function fmtDate(obj){//通过js将时间戳转换成"yyyy--mm--dd"格式
...
function fomatetime(time) {
    ...
    var str1 = newtime.replace('T', ' ');
    return str1;
}

//获取当前时间，格式YYYY-MM-DD HH
...
exports.setProductPlan = setProductPlan;
exports.setProductclause = setProductclause;
exports.setProductPrice = setProductPrice;
exports.setRelationships = setRelationships;
exports.setSex = setSex;
exports.setPDF = setPDF;
var CHANGE_PRODUCT = exports.CHANGE_PRODUCT = 'CHANGE_PRODUCT';
var SET_PRODUCT_INFO = exports.SET_PRODUCT_INFO = 'SET_PRODUCT_INFO';
var SET_PRODUCT_PLAN = exports.SET_PRODUCT_PLAN = 'SET_PRODUCT_PLAN';
var SET_PRODUCT_CLAUSELIST = exports.SET_PRODUCT_CLAUSELIST = 'SET_PRODUCT_CLAUSELIST';
var SET_PRODUCT_PRICE = exports.SET_PRODUCT_PRICE = 'SET_PRODUCT_PRICE';
var SET_PREMIUM = exports.SET_PREMIUM = 'SET_PREMIUM';
var SET_RELATIONSHIPS = exports.SET_RELATIONSHIPS = 'SET_RELATIONSHIPS';
var SET_SEX = exports.SET_SEX = 'SET_SEX';
var SET_PDF = exports.SET_PDF = 'SET_PDF';

function changeProduct(id) {
    return { type: CHANGE_PRODUCT, id: id };
}

function setProductInfo(product) {
    return { type: SET_PRODUCT_INFO, product: product };
}

function setProductPlan(planForm) {
    return { type: SET_PRODUCT_PLAN, planForm: planForm };
}

function setProductclause(clauseList) {
    return { type: SET_PRODUCT_CLAUSELIST, clauseList: clauseList };
}

function setProductPrice(price) {
    return { type: SET_PRODUCT_PRICE, price: price };
}

// export function setPremium (price) {
//     return { type: SET_PRODUCT_PRICE, price }
// }

function setRelationships(relationships) {
    return { type: SET_RELATIONSHIPS, relationships: relationships };
}
...
var createHistorya = __webpack_require__(35).createBrowserHistory; // import createHistory from 'history/createBrowserHistory';
// export default createHistory();
// using an ES6 transpiler, like babel
exports.default = createHistorya();
...
var _history = __webpack_require__(146);
...
//   console.log('上一个值：',prevState,'下一个值：',currentState)
//   }
// )

// store.dispatch(setTokenDelay('真是的'))

// store.dispatch(changeProduct('f67f5590-6305-40bc-a012-16ea725e785哈哈7'));
// unsubscribe();
...
if (false) {
    ...
    module.hot.accept(function () {
        ReactDom.render(_react2.default.createElement(_App2.default, null), document.getElementById('root'));
    }), function () {
        render((0, _store2.default)());
    };
}
...
var k=__webpack_require__(105),n="function"===typeof Symbol&&Symbol.for,p=n?Symbol.for("react.element"):60103,q=n?Symbol.for("react.portal"):60106,r=n?Symbol.for("react.fragment"):60107,t=n?Symbol.for("react.strict_mode"):60108,u=n?Symbol.for("react.profiler"):60114,v=n?Symbol.for("react.provider"):60109,w=n?Symbol.for("react.context"):60110,x=n?Symbol.for("react.concurrent_mode"):60111,y=n?Symbol.for("react.forward_ref"):60112,z=n?Symbol.for("react.suspense"):60113,aa=n?Symbol.for("react.memo"):
...
*/
var aa=__webpack_require__(9),n=__webpack_require__(105),r=__webpack_require__(154);function ba(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var l=[c,d,e,f,g,h],k=0;a=Error(b.replace(/%s/g,function(){return l[k++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
// module
exports.push([module.i, "body {\n  position: relative;\n  background-color: #fff !important;\n  margin: 0;\n  padding: 0;\n  -webkit-overflow-scrolling: touch;\n  font-family: \"PingFangSC-Regular\",\"HelveticaNeue\",\"Helvetica Neue\",Helvetica,\"Microsoft Yahei\",Arial, sans-serif; }\n  body p {\n    margin: 0;\n    text-align: left; }\n  body .prod_page {\n    width: 100%; }\n  body .page {\n    padding-bottom: 0.98rem; }\n  body .stickyDiv {\n    z-index: 99; }\n  body .agreement {\n    width: 100%;\n    box-sizing: border-box;\n    padding: 0.075rem 4%;\n    padding-bottom: 0.15rem;\n    border-top: 0.005rem solid #ebebeb;\n    overflow: hidden; }\n    body .agreement .left {\n      float: left;\n      width: 8.6%; }\n      body .agreement .left img {\n        width: 100%; }\n    body .agreement .right {\n      float: left;\n      width: 91.4%;\n      font-size: 12px;\n      color: #494949;\n      line-height: 20px;\n      margin-top: 6px; }\n      body .agreement .right .p2 {\n        color: #999; }\n      body .agreement .right .p1 {\n        margin-bottom: 4px; }\n        body .agreement .right .p1 a {\n          color: #24c789; }\n\n.cashier {\n  width: 100%;\n  padding-top: 49px; }\n\n.am-picker-popup-item, .am-modal-button-group-h .am-modal-button:last-child, .am-modal-button-group-v .am-modal-button {\n  color: #24c789 !important; }\n\n.am-picker-popup-title {\n  color: #000 !important; }\n\n.am-modal-transparent .am-modal-content {\n  border-radius: 20px !important; }\n\n.am-modal-alert-content, .am-modal-propmt-content {\n  text-align: left; }\n\ninput:disabled, input[disabled] {\n  -webkit-text-fill-color: #494949;\n  background-color: #fff;\n  -webkit-opacity: 1;\n  opacity: 1;\n  border: none; }\n\ninput::-webkit-input-placeholder, textarea::-webkit-input-placeholder {\n  /* WebKit browsers */\n  color: #C8C8C8; }\n\ninput:-moz-placeholder, textarea:-moz-placeholder {\n  /* Mozilla Firefox 4 to 18 */\n  color: #C8C8C8; }\n\ninput::-moz-placeholder, textarea::-moz-placeholder {\n  /* Mozilla Firefox 19+ */\n  color: #C8C8C8; }\n\ninput:-ms-input-placeholder, textarea:-ms-input-placeholder {\n  /* Internet Explorer 10+ */\n  color: #C8C8C8; }\n\n.am-tabs-pane-wrap {\n  overflow-y: inherit !important; }\n", ""]);
...
var _commFunction = __webpack_require__(77);
...
var _action2 = __webpack_require__(76);
...
// const Index = asyncComponent(() => import('views/index.js'));
...
// prodDat作为connect的第一个参数，从store 中单独拿出uuid 
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(States)(App));
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(13)(proto, TO_PRIMITIVE, __webpack_require__(244));
...
$export($export.P + $export.F * (__webpack_require__(54) != Object || !__webpack_require__(24)(arrayJoin)), 'Array', {
...
var Product_Index = (0, _commFunction.asyncComponent)(function () {
  return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 376));
});
// import Product_Index from './index/prodE_anxin.js';
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(Product_Index, null)
      );
    }
  }]);
...
exports.default = (0, _reactRouterDom.withRouter)((0, _reactRedux.connect)(States)(Index));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(52), __webpack_require__(369)(module)))
...
var _reduxLogger = __webpack_require__(373);
...
if (true) {
    ...
    createStoreWithMiddleware = (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, (0, _reduxLogger.createLogger)()), window.devToolsExtension ? window.devToolsExtension() : function (f) {
        return f;
    })(_redux.createStore);
}

exports.default = function (initState) {
    return createStoreWithMiddleware(_reducers2.default, initState);
};
...
// function changeProduct (state = {'uuid':'f67f5590-6305-40bc-a012-16ea725e36f6', 'name':'安心E家'}, action) {
// function changeProduct (state = {'id':'AXEJ'}, action) {
//     switch(action.type) {
//         case CHANGE_PRODUCT:
...
// 全局通用的token
function setToken() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'token': null };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_TOKEN:
            var c = action.token;
            // document.cookie="argT=;"
            return Object.assign({}, state, {
                token: c
            });
        default:
...
function setOrderInfo() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'orderInfo': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_ORDER_INFO:
            return Object.assign({}, state, {
...
function setUserid() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'userid': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_USERID:
            return Object.assign({}, state, {
...
function setPlan() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'selectplan': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PLAN:
            return Object.assign({}, state, {
...
function setIdcar() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'idcar': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_IDCAR:
            return Object.assign({}, state, {
                idcar: action.idcar
            });
        default:
...
var todoApp = (0, _redux.combineReducers)({
    product: _reducer2.default, setProductInfo: _reducer.setProductInfo, setProductPlan: _reducer.setProductPlan, setToken: setToken
});
...
function changeProduct() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'id': 'AXEJ' };
    var action = arguments[1];

    switch (action.type) {
        case _action.CHANGE_PRODUCT:
            return Object.assign({}, state, {
                id: action.id
            });
        default:
...
function setProductInfo() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'product': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PRODUCT_INFO:
            return Object.assign({}, state, {
...
function setProductPlan() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'planForm': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PRODUCT_PLAN:
            return Object.assign({}, state, {
                planForm: action.planForm
            });
        default:
            return state;
    }
...
function setProductclause() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'clauseList': [] };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PRODUCT_CLAUSELIST:
            return Object.assign({}, state, {
                planForm: action.clauseList
            });
        default:
            return state;
    }
...
function setProductPrice() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'price': 0 };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PRODUCT_PRICE:
            return Object.assign({}, state, {
                price: action.price
            });
        default:
...
function setRelationships() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'relationships': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_RELATIONSHIPS:
            return Object.assign({}, state, {
...
function setSex() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'sex': {} };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_SEX:
            return Object.assign({}, state, {
                sex: action.sex
            });
        default:
...
function setPDF() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { 'pdf': '' };
    var action = arguments[1];

    switch (action.type) {
        case _action.SET_PDF:
            return Object.assign({}, state, {
                pdf: action.pdf
            });
        default:
...
//     changeProduct,setProductInfo,setProductPlan
// });
